...
#ifndef RTW_HEADER_gjwwzq_h_
#define RTW_HEADER_gjwwzq_h_
#ifndef gjwwzq_COMMON_INCLUDES_
#define gjwwzq_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#define gjwwzq_rtModel                 RT_MODEL_gjwwzq_T
...
#define rtB                            gjwwzq_B
#define BlockIO                        B_gjwwzq_T
#define rtX                            gjwwzq_X
#define ContinuousStates               X_gjwwzq_T
#define rtXdot                         gjwwzq_XDot
#define StateDerivatives               XDot_gjwwzq_T
#define tXdis                          gjwwzq_XDis
#define StateDisabled                  XDis_gjwwzq_T
#define rtP                            gjwwzq_P
#define Parameters                     P_gjwwzq_T
#define rtDWork                        gjwwzq_DW
#define D_Work                         DW_gjwwzq_T
...
struct P_gjwwzq_T_ {
  ...
  uint32_T HILWrite_analog_channels; /* Mask Parameter: HILWrite_analog_channels
                                      ...
                                      */
  real_T Gain10_Gain[4];               /* Expression: [1 0 0 0]
                                        * Referenced by: '<Root>/Gain10'
                                        */
  real_T Gain11_Gain[4];         /* Expression: [-3.5987,48.5031,-1.6468,3.2252]
  ...
  real_T HILInitialize_OOWatchdog[3];  /* Expression: watchdog_other_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T Gain1_Gain;                   /* Expression: 2*pi/2048
  ...
  real_T SignalGenerator1_Amplitude;   /* Expression: 1
                                        ...
                                        */
  real_T SignalGenerator1_Frequency;   /* Expression: 0.125
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
...
extern P_gjwwzq_T gjwwzq_P;

/* Block signals (default storage) */
extern B_gjwwzq_T gjwwzq_B;

/* Continuous states (default storage) */
extern X_gjwwzq_T gjwwzq_X;

/* Block states (default storage) */
extern DW_gjwwzq_T gjwwzq_DW;

/* Model entry point functions */
extern void gjwwzq_initialize(void);
extern void gjwwzq_output(void);
extern void gjwwzq_update(void);
extern void gjwwzq_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern gjwwzq_rtModel *gjwwzq(void);
...
extern RT_MODEL_gjwwzq_T *const gjwwzq_M;
 ...
 *
 * '<Root>' : 'gjwwzq'
 * '<S1>'   : 'gjwwzq/Compare To Constant1'
 * '<S2>'   : 'gjwwzq/Degrees to Radians1'
 * '<S3>'   : 'gjwwzq/Powered by QUARC'
 * '<S4>'   : 'gjwwzq/Quanser'
 * '<S5>'   : 'gjwwzq/Radians to Degrees5'
 * '<S6>'   : 'gjwwzq/Radians to Degrees6'
 */
#endif                                 /* RTW_HEADER_gjwwzq_h_ */
